            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <label className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Enable organization registration
                  </p>
                </div>
                <input
                  type="checkbox"
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Intrusion Detection System for all networks
                </p>
              </div>
              <input
                type="checkbox"
                ...
                onChange={(e) =>
                  setSettings({ ...settings, enableIDS: e.target.checked })
                }
                className="w-5 h-5 text-indigo-600 rounded"
              />
            </label>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      maxNetworksPerOrg: parseInt(e.target.value),
                    })
                  }
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                />
